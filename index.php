...
<div class="ingreso">
    <li><a href="ingreso.php"><span><img src="Imagenes/iniciar.png" alt=""  width="20px" ></span> Iniciar Sesión</a></li>
...
<div class="row">
    <div class="col-xs-4col-md-3">
      <div class="thumbnail">
        <img src="Imagenes/34.jpg" alt="" height="200px">
        <div class="caption">
    ...
    <div class="col-xs-4col-md-3">
        <div class="thumbnail">
            <img src="Imagenes/fds.jpg" alt="" width="300px" height="200px">
            <div class="caption">
                <h4>Titulo de la imagen</h4>
                <p>aque se ponde juan desscripoidicon de la for osf sdofnsd fisdfs flsdfljsfsdlfsdfsdfj sdfsdkf sdfsd fjsdf lsdfsdf</p>
                <a href="#" class="btn btn-primary btn-sm">Leer más</a>
    ...
    <div class="col-xs-4col-md-3">
    <div class="thumbnail">
        <img src="Imagenes/ddd.jpg" alt="" height="200px">
        <div class="caption">
            <h4>Titulo de la imagen</h4>
            <p>aque se ponde juan desscripoidicon de la for osf sdofnsd fisdfs flsdfljsfsdlfsdfsdfj sdfsdkf sdfsd fjsdf lsdfsdf</p>
            <a href="#" class="btn btn-primary btn-sm">Leer más</a>
    ...
    <div class="col-xs-4col-md-3">
      <div class="thumbnail">
        <img src="Imagenes/g1.gif" alt="" height="200px">
        <div class="caption">
            <h4>Titulo de la imagen</h4>
            <p>aque se ponde juan desscripoidicon de la for osf sdofnsd fisdfs flsdfljsfsdlfsdfsdfj sdfsdkf sdfsd fjsdf lsdfsdf</p>
            <a href="#" class="btn btn-primary btn-sm">Leer más</a>
